...
class MapSource(object):
    ...
    providers = {
        "mapnik": (0, 0, 19, "http://tile.openstreetmap.org/{z}/{x}/{y}.png",
                   ""),
        "osm-hot-fr": (0, 0, 19, "http://{s}.tile.openstreetmap.fr/hot/{z}/{x}/{y}.png",
                       ""),
    ...
    def __init__(self,
        ...
        cache_key="mapnik", min_zoom=0, max_zoom=19, tile_size=256,
        image_ext="png", attribution=""):
    ...
    def from_provider(key):
        is_overlay, min_zoom, max_zoom, url, attribution = \
            MapSource.providers[key]
...
class MapView(Widget):
    ...
    def on_map_source(self, instance, source):
        if isinstance(source, string_types):
            ...
            cache_key, min_zoom, max_zoom, url, attribution = source
...
RelativeLayout:
    ...
    Toolbar:
        ...
        Button:
            text: "Mapnik"
            on_release: mapview.map_source = "mapnik"
        Button:
            text: "OSM FR"
            on_release: mapview.map_source = "osm-fr"
        Button:
            text: "OSM DE"
            on_release: mapview.map_source = "osm-de"
        Button:
            text: "OSM Hot"
            on_release: mapview.map_source = "osm-hot-fr"
